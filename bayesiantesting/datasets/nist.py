...
class NISTDataSet:
    ...
    def filter(self, minimum_temperature, maximum_temperature, maximum_data_points):
        ...
        for data_type in self.data_types:
            ...
            if maximum_data_points > 1 and int(np.floor(data_frame.shape[0] / (maximum_data_points - 1))) == 0:
                slicer = 1
            else:
                slicer = int(np.floor(data_frame.shape[0] / max(1, maximum_data_points - 1)))
