...
* `scripts`
  ...
  * `install_miniconda.sh`: Helper program for installing the latest Miniconda.
...
e.g. `bayesiantesting-0.1.2`, otherwise it will be appended with `+X` where `X` is the number of commits 
